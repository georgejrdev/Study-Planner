...
function createText(subject_id, title, text, date) {
...
function updateText(id, subject_id, title, text) {
    return new Promise((resolve, reject) => {
...
module.exports = { createText, removeText, updateText, fullTextSearch };
